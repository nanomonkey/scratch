...
[:path d="M7.46 2.75h15.08a.5.5 0 0 1 .5.5v4.22a.5.5 0 0 1-.5.5H7.46a.5.5 0 0 1-.46-.5V3.25a.5.5 0 0 1 .46-.5z" fill="#a7a9ac" fill-rule="evenodd"]
[:path d="M8.54 15.27h12.92a.5.5 0 0 1 .5.5v10.48a.5.5 0 0 1-.5.5H8.54a.5.5 0 0 1-.5-.5V15.77a.5.5 0 0 1 .5-.5z" fill="none" stroke="#a7a9ac" stroke-miterlimit="10"]
[:path d="M1.5 9h27a1.5 1.5 0 0 1 1.5 1.5V19a1.5 1.5 0 0 1-1.5 1.5h-27A1.5 1.5 0 0 1 0 19v-8.49A1.5 1.5 0 0 1 1.5 9z" fill="#a7a9ac" fill-rule="evenodd"]
...
[:path d="M35 37.07l-.8.6-12.9-17.1.8-.6zM26.82 2l.9.2-6 18-1-.2zM19.82 18.87l.2 1-4.95 1-13.25 2.8-.2-1z" fill="none" stroke="#fff" stroke-width="3"]
...
[:path d="M18 4A14 14 0 1 1 4 18 14 14 0 0 1 18 4m0-4a18 18 0 1 0 18 18A18 18 0 0 0 18 0z" fill="#cacaca"]
